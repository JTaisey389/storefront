        ...
        <CardContent>
              ...
              return (
                <div className={classes.form}>
                  ...
                  <Button
                    ...
                    onClick={() => props.removeFromCart(products)}
                    size="small"
                  >
                    Remove
                  </Button>
          ...
          <form className={classes.form} noValidate autoComplete="off">
            <div className={classes.inputForm}>
              ...
              <div className={classes.inputs}>
                <TextField required id="standard-basic" defaultValue="City" />
              </div>
              <div className={classes.inputs}>
                <TextField required id="standard-basic" defaultValue="State" />
              </div>
              <div className={classes.inputs}>
                <TextField required id="standard-basic" defaultValue="Zip" />
              </div>
            </div>
            <div className={classes.inputForm}>
              <Typography className={classes.title} variant="h5" component="h2">
              ...
              <div className={classes.inputs}>
                <TextField required id="standard-required" defaultValue="CVV" />
              </div>
            </div>
          </form>
          <CardActions>
            <Button className={classes.checkoutButton} size="small">
              PLACE YOUR ORDER
            </Button>
          </CardActions>
        </CardContent>
